...
public class PerfectExperimentChase : RayCastController {
    ...
    void Update() {
        ...
        transform.position = Vector3.Lerp(transform.position, new Vector3(transform.position.x, target.transform.position.y, transform.position.z), Time.deltaTime);
